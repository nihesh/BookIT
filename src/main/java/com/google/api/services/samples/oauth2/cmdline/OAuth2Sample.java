...
package main.java.com.google.api.services.samples.oauth2.cmdline;
...
public class OAuth2Sample {
   ...
   */
  private static final String APPLICATION_NAME = "BookIT";
  ...
  private static Credential authorize() throws Exception {
    ...
    clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
        new InputStreamReader(OAuth2Sample.class.getResourceAsStream("/main/resources/client_secrets.json")));
  ...
  private static String userInfo() throws IOException {
